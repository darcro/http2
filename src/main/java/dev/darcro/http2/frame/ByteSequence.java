...
public final class ByteSequence {
    ...
    /** Returns a zero-copy read-only view of the complete array. */
    public static ByteSequence wrap(byte[] bytes) {
        Objects.requireNonNull(bytes, "bytes");
        return new ByteSequence(bytes, 0, bytes.length);
    }

    /** Returns a zero-copy read-only view of the selected array range. */
